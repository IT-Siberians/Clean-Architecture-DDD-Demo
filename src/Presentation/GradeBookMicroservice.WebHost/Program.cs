...
builder.Services.AddScoped<IRepository<Student,Guid>, EfStudentRepository>();
builder.Services.AddScoped<IStudentsApplicationService, StudentsApplicationService>();
builder.Services.AddScoped<IRepository<Teacher, Guid>, EfTeacherRepository>();
builder.Services.AddScoped<ITeachersApplicationService, TeachersApplicationService>();
builder.Services.AddScoped<IRepository<Lesson, Guid>, EfLessonRepository>();
